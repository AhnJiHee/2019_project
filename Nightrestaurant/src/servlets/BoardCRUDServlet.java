	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (action.equals("삭제")) {
			...
			html = "<!DOCTYPE html>" + "<html>" + "<head>"
					...
					+ "	<img src='images/trash.png' width='150px' height='150px' alt=''><br>"
					+ "	<font size='7em' color='black'>게시글이 </font> <font size='7em'"
			...
			html = "<!DOCTYPE html>" + "<html>" + "<head>"
					...
					+ "	text-align: center;" + "	text-decoration: none;" + "	display: inline-block;"
					+ "	font-size: 16px;" + "}" + "</style>" + "</head>" + "<body background='images/background.png'>"
					+ "	<font size='2em' color='silver'>*게시글 수정</font><br><div>"
					+ "	<img src='images/Mark.png' width='150px' height='150px' alt=''><br>"
					+ "	<font size='7em' color='black'>게시글이 </font> <font size='7em' color='black'"
					+ "	style='font-weight: bold'>수정</font> <font size='7em' color='black'>되었습니다.</font><br><br>"
					+ "<table class='list' border='2px'><tr>" + "<td>제목</td><td>" + newtitle + "</td>"
					+ "	</tr>" + "	<tr>" + "		<td>작성자</td><td>" + boardwriter + "</td>" + "	</tr>" + "	<tr>"
					+ "		<td height='300'>내용</td><td width=500>" + newcontents + "</td>" + "	</tr>" + "</table>"
					+ "<form class='center' action='test.jsp'><input type=submit value='메인으로 돌아가기'></form>";
			...
			html = "<!DOCTYPE html>" + "<html>" + "<head>"
					...
					+ "<font size='2em' color='silver'>*게시글 저장</font><br><div>"
					+ "<img src='images/Mark.png' width='150px' height='150px' alt=''><br>"
					+ "<font size='7em' color='black'>게시글이 </font> <font size='7em'"
					+ "style='font-weight: bold'>저장</font> <font size='7em'>되었습니다.</font><br><br>"
					+ "<table class='list' border='2px'>" + "<tr>" + "<td>제목</td><td>" + boardtitle + "</td>" + "</tr>"
