...
<body class="is-preload">
	...
	<section id="one" class="main style2 right dark fullscreen">
		...
		<div class="content box style2"
			...
			<div class="tabs" >
				<div class="tab-2" >
					<label for="tab2-1" id="tores" style = "font-family: NanumSquareR">심야 식당 찾기</label> <input id="tab2-1"
				...
				<div class="tab-2" >
					<label for="tab2-2" id="toboard" style = "font-family: NanumSquareR">게시판 보기</label> <input id="tab2-2"
			...
			<article class="from-left">
				...
				<figcaption>
					<h3>
						...
						<a href="https://store.naver.com/restaurants/detail?id=1127738824"
			...
			<article class="from-right">
				...
				<figcaption>
					<h3>
						...
						<a href="https://store.naver.com/restaurants/detail?id=1540634517"
							target="_blank"><img src="images/right-arrow.png"
							width="30px" height="30px"></a>
					</h3>
				</figcaption>
			...
			<article class="from-right">
				...
				<figcaption>
					<h3>
						...
						<a href="https://store.naver.com/restaurants/detail?id=37524875"
							target="_blank"><img src="images/right-arrow.png"
							width="30px" height="30px"></a>
					</h3>
				</figcaption>
